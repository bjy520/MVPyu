...
import com.shuaiyu.mvpyu.ceshi.BlogService;
import com.shuaiyu.mvpyu.db.Dao;
import com.shuaiyu.mvpyu.db.DaoUtils;
import com.shuaiyu.mvpyu.main.KeyView;
import com.shuaiyu.mvpyu.utils.SoudPoolsUtil;
...
//            },3000);
    ...
    private void init() {
        spu = SoudPoolsUtil.getInstance(getApplicationContext());
    }
...
//            }
    ...
    private void ceshi() {
        ...
        Call<ResponseBody> call = service.getBlog("17316266771");

        Log.e(TAG, call.request().toString() + "------");
        https:
//tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=17316266771
// 用法和OkHttp的call如出一辙,
// 不同的是如果是Android系统回调方法执行在主线程
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                Log.e(TAG, "onResponse: " + result + response.message());
                String t1 = gson.toJson(result);
                Log.e(TAG, "onResponse: " + t1);
            }
        ...
        Toast.makeText(this, getChannel(getApplicationContext()), Toast.LENGTH_LONG).show();
    }
